...
The ruffe is an aggressive invasive fish. It has a rapid population growth. The ruffe eats a variety of foods. The ruffe has a lack of natural predators which creates the potential to displace other species in newly invaded areas and to cause the native fish populations to decrease.
```{r}
ruf = RuffeSLRH92
colnames(ruf)
```
...
agemat = mean(agemat[1,] + agemat[2,], na.rm=T)
lifespan = 
